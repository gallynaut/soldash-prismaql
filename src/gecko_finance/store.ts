...
export async function createGeckoFinanceRecord( ctx: Context, geckoFinanceRecord: any ) {
  let geckoFinance:GeckoFinance
  try {
    geckoFinance = await ctx.prisma.geckoFinance.create({data: geckoFinanceRecord})
